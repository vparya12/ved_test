...
<html>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(<c:url value="/pages/images/img_bg_1.jpg"/>)" data-stellar-background-ratio="0.5">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_1.jpg" class="fh5co-card-item image-popup">
						<figure>
							...
							<img src="<c:url value="/pages/images/img_1.jpg"/>" alt="Image" class="img-responsive">
						</figure>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_2.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="<c:url value="/pages/images/img_2.jpg"/>" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_3.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="<c:url value="/pages/images/img_3.jpg"/>" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_4.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="<c:url value="/pages/images/img_4.jpg"/>" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
							<h2>Organic Egg</h2>
							<p>Far far away, behind the word mountains, far from the countries Vokalia..</p>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_5.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="<c:url value="/pages/images/img_5.jpg"/>" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_6.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="<c:url value="/pages/images/img_6.jpg"/>" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
	...
	<div class="gtco-cover gtco-cover-sm" style="background-image: url(<c:url value="/pages/images/img_bg_1.jpg"/>)"  data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
